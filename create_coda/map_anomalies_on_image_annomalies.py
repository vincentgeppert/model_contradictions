...
def map_anomalies_on_image(path_velo, path_labels, path_img, path_clustering_3, path_clustering_4, path_original_label, path_calibrations, path_save, anno, frame_img, dataset):
    #open point cloud
...
def main(anno):
    ...
    for frame in range(len(frames)):
        ...
        map_anomalies_on_image(path_pc_velo_camerafov_frame, path_anomaly_labels_frame, path_image_frame, path_clusters_frame_3, path_clusters_frame_4, path_original_label_frame, path_calib_frame, path_groundtruth_eval, anno, frame_image, dataset)
